...
import com.crave.food.csse_android_app.adapters.ManageReceiptAdapter;
...
public class Manage_receipt extends AppCompatActivity {

    DatabaseReference databaseRecept;
    RecyclerView recyclerView;
    ManageReceiptAdapter receiptAdapter;
    ...
    protected void onStart() {
        ...
        databaseRecept.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                receiptAdapter = new ManageReceiptAdapter(Manage_receipt.this,receiptList);
